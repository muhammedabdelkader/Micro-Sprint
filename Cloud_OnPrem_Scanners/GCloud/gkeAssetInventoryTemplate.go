...
/*
Use the Kubernetes Go client library to connect to your GKE cluster and use the Kubernetes API to list all the pods, services, deployments, and statefulsets. This can be used to get an inventory of all the assets running in GKE.
*/
func main() {
